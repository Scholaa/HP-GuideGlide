...
// 							<Authenticator>
// 								{({ signOut, user }) => (
// 									<TransportSafetyPage signOut={signOut} />
// 								)}
// 							</Authenticator>
// 						}
// 					/>
...
// 						element={
// 							<Authenticator>
// 								{({ signOut, user }) => <WeatherPage signOut={signOut} />}
// 							</Authenticator>
// 						}
// 					/>
// 					<Route
...
// 						element={
// 							<Authenticator>
// 								{({ signOut, user }) => <ProfilePage signOut={signOut} />}
// 							</Authenticator>
// 						}
// 					/>
// 					<Route
...
// 										}
// 										return <Navigate to="/map" replace />; // Redirect to profile after login
// 									}
